          ...
          Expanded(child: TextButton(
            onPressed: () {
              if(isCurrency) {
                ...
                Provider.of<CategoryProvider>(context, listen: false).getCategoryList(true, context, AppConstants.languages[index].countryCode);
                Provider.of<HomeCategoryProductProvider>(context, listen: false).getHomeCategoryProductList(true, context, AppConstants.languages[index].countryCode);
                Provider.of<TopSellerProvider>(context, listen: false).getTopSellerList(true, context, AppConstants.languages[index].countryCode);
                Provider.of<BrandProvider>(context, listen: false).getBrandList(true, context, AppConstants.languages[index].countryCode);
                Provider.of<ProductProvider>(context, listen: false).getLatestProductList(1, context, AppConstants.languages[index].countryCode, reload: true);
                Provider.of<ProductProvider>(context, listen: false).getFeaturedProductList('1', context, AppConstants.languages[index].countryCode, reload: true);
                Provider.of<FeaturedDealProvider>(context, listen: false).getFeaturedDealList(true, context, AppConstants.languages[index].countryCode);
                Provider.of<ProductProvider>(context, listen: false).getLProductList('1', context, AppConstants.languages[index].countryCode, reload: true);
              }
