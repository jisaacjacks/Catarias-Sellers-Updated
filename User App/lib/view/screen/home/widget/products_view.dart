      ...
      if(scrollController.position.maxScrollExtent == scrollController.position.pixels
        ...
        if(offset < pageSize) {
          ...
          if(productType == ProductType.SELLER_PRODUCT) {
            Provider.of<ProductProvider>(context, listen: false).initSellerProductList(sellerId, offset, context, Provider.of<LocalizationProvider>(context, listen: false).locale.countryCode,);
          }else{
            Provider.of<ProductProvider>(context, listen: false).getLatestProductList(offset, context, Provider.of<LocalizationProvider>(context, listen: false).locale.countryCode,
            );
          }
