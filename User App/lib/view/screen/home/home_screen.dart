...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    super.initState();
    Provider.of<FlashDealProvider>(context, listen: false).getMegaDealList(true, context, Provider.of<LocalizationProvider>(context, listen: false).locale.countryCode,true);
      ...
      body: SafeArea(
        child: RefreshIndicator(
          ...
          onRefresh: () async {
            ...
            await Provider.of<FlashDealProvider>(context, listen: false).getMegaDealList(true, context, Provider.of<LocalizationProvider>(context, listen: false).locale.countryCode,false);
                        ...
                        return Row(children: [
                          ...
                          prodProvider.latestProductList != null ? PopupMenuButton(
                            ...
                            onSelected: (value) {
                              ...
                              Provider.of<ProductProvider>(context, listen: false).getLatestProductList(1, context, Provider.of<LocalizationProvider>(context, listen: false).locale.countryCode, reload: true);
