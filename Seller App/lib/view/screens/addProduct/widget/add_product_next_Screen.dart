...
class _AddProductNextScreenState extends State<AddProductNextScreen> {
  ...
  void _load(){
    ...
    Provider.of<RestaurantProvider>(context,listen: false).getCategoryList(context,widget.product);
                    ...
                    Container(
                      ...
                      child: DropdownButton<int>(
                        ...
                        return DropdownMenuItem<int>(
                          ...
                          child: Text( value != 0? resProvider.categoryList[(resProvider.categoryIds.indexOf(value) -1)].name: 'Select'),
                        );
                      }).toList(),
                        onChanged: (int value) {
                                ...
                                child: DropdownButton<int>(
                                  ...
                                  items: resProvider.subCategoryIds.map((int value) {
                                    return DropdownMenuItem<int>(
                                      ...
                                      child: Text(value != 0 ? resProvider.subCategoryList[(resProvider.subCategoryIds.indexOf(value) - 1)].name : 'Select'),
                                    );
                                  }).toList(),
                                  onChanged: (int value) {
                                ...
                                child: DropdownButton<int>(
                                  ...
                                  items: resProvider.subSubCategoryIds.map((int value) {
                                    return DropdownMenuItem<int>(
                                      ...
                                      child: Text(value != 0 ? resProvider.subSubCategoryList[(resProvider.subSubCategoryIds.indexOf(value)-1)].name : 'Select'),
                                    );
                                  }).toList(),
                                  onChanged: (int value) {
